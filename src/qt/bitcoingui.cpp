...
{
    resize(850, 550);
    setWindowTitle(tr("momentum-beta") + " - " + tr("Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a momentum-beta address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/info"), tr("&About momentum-beta"), this);
    aboutAction->setToolTip(tr("Show information about momentum-beta"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for momentum-beta"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("Show/Hide &momentum-beta"), this);
    toggleHideAction->setToolTip(tr("Show or hide the momentum-beta window"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->addAction(encryptWalletAction);
...
void QMainWindow::addToolBar(Qt::ToolBarArea left, QToolBar * toolbar){}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("momentum-beta client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("momentum-beta client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide momentum-beta"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    case 5: case 6: case 7: case 8: icon = ":/icons/connect_2"; break;
    default: icon = ":/icons/connect_3"; break;
    }
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSPMM_ICONSIZE,STATUSPMM_ICONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to momentum-beta network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(secs < 90*60 && count >= nTotalBlocks)
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(":/icons/synced").pixmap(STATUSPMM_ICONSIZE, STATUSPMM_ICONSIZE));
    ...
    else
    {
     ...
     //   syncIconMovie->start();
        ...
        labelBlocksIcon->setPixmap(QIcon(":/icons/notsynced").pixmap(STATUSPMM_ICONSIZE, STATUSPMM_ICONSIZE));
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_active").pixmap(STATUSPMM_ICONSIZE,STATUSPMM_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Mining momentum-beta at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSPMM_ICONSIZE,STATUSPMM_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Not mining momentum-beta"));
    }
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid momentum-beta address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_open").pixmap(STATUSPMM_ICONSIZE,STATUSPMM_ICONSIZE));
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_closed").pixmap(STATUSPMM_ICONSIZE,STATUSPMM_ICONSIZE));
