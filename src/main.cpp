...
uint256 hashGenesisBlock("0x730f5d27d6108677f9d129a61c9f3bd5543107bfc5e0e20cfda0fd86171ee9d1");
...
const string strMessageMagic = "momentum-beta Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if (nHeight < 525600){
    	    nSubsidy = (525600 - nHeight) * COIN;
    }

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // momentum-beta: 1 days
static const int64 nTargetSpacing = 60; // momentum-beta: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal momentum-beta miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "momentum-beta", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x02d8232562fd9888f4dd5704a39e1a322226715edd8316abdc0db988624095e6");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp ="21/01/2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
	block.nTime    = 1390306900; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2013091;

        if (fTestNet)
        {
            block.nTime    = 1390298700;
            block.nNonce   = 815778;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb5d0da0a495d6936c912ca3f09dd60d88a640f32850c6a2138354caa95dde5bc"));
