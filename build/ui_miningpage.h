...
**
** Created: Sat Jan 25 15:55:54 2014
...
public:
    ...
    void setupUi(QWidget *MiningPage)
    {
        ...
        threadsBox->setMaximum(20);
        threadsBox->setSingleStep(1);
        threadsBox->setValue(11);
    ...
    void retranslateUi(QWidget *MiningPage)
    {
        ...
        threadsLabel->setText(QApplication::translate("MiningPage", "Intensity", 0, QApplication::UnicodeUTF8));
