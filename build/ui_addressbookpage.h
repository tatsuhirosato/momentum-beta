...
**
** Created: Sat Jan 25 16:45:51 2014
...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->resize(829, 380);
        AddressBookPage->setStyleSheet(QString::fromUtf8("font: 25 10pt \"URW Gothic L\";"));
        ...
        copyToClipboard->setStyleSheet(QString::fromUtf8(""));
        QIcon icon1;
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your momentum-beta addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0, QApplication::UnicodeUTF8));
